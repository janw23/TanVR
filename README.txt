...
In order to disable device's camera overlay ARCore's script has to be modified (you can change original one or just create a copy and then replace where needed).
